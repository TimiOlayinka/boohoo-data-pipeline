"""Generate all dbt models following HnB naming convention:
  rdl_{source} ΓåÆ history dedup + field normalization
  odl          ΓåÆ star schema (dim_*, fact_*)
  adl/bi       ΓåÆ materialized views for dashboards
"""
import os
...
# ============================================================
# RDL MODELS ΓÇö one per brand per dataset, dedup from _history
# ============================================================
RDL_CUSTOMERS = {
...
# ============================================================
# ODL MODELS ΓÇö star schema (dim_*, fact_*)
# ============================================================
...
# ============================================================
# ADL/BI MODELS ΓÇö materialized views for dashboards
# ============================================================
print("\nADL/BI models:")
