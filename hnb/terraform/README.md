# HNB Terraform Infrastructure

This directory contains all Infrastructure as Code (IaC) for the HNB Data Pipeline.
...
| `iam.tf` | Lambda execution role (`HNBDataGeneratorRole`) |
