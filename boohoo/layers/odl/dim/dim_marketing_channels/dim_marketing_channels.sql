...
DROP TABLE IF EXISTS "dev_odl".dim_marketing_channels;

CREATE TABLE "dev_odl".dim_marketing_channels
DISTSTYLE ALL
SORTKEY (channel_l1)
AS
SELECT 'Paid Social'       :: VARCHAR(50) AS channel_l1, 'Meta Ads'          :: VARCHAR(50) AS channel_l2, 'Facebook'         :: VARCHAR(50) AS channel_l3, 'meta_ads'       :: VARCHAR(50) AS source_system
