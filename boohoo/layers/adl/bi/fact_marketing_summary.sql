...
DROP TABLE IF EXISTS "adl_bi".fact_marketing_summary;

CREATE TABLE "adl_bi".fact_marketing_summary
...
combined AS (
    SELECT
        ...
        ROUND(COALESCE(r.converting_sessions, 0)::FLOAT / NULLIF(r.total_sessions, 0) * 100, 2)
                                                                            AS site_conversion_rate
