...
------------------------------------------------------------------------------------------------------------------------
-- nastygal_orders
-- Deduplicated NastyGal orders from nastygal_orders_history
------------------------------------------------------------------------------------------------------------------------
...
DROP TABLE IF EXISTS "rdl_shopify".nastygal_orders;

CREATE TABLE "rdl_shopify".nastygal_orders
...
WITH history AS (
    ...
    FROM "rdl_shopify".nastygal_orders_history
),
dedup AS (
