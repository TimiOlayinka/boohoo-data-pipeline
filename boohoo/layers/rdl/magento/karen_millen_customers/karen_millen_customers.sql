...
-- Deduplicated Karen Millen customers from karen_millen_customers_history
------------------------------------------------------------------------------------------------------------------------
...
DROP TABLE IF EXISTS "rdl_magento".karen_millen_customers;

CREATE TABLE "rdl_magento".karen_millen_customers
...
WITH history AS (
    ...
    FROM "rdl_magento".karen_millen_customers_history
),
dedup AS (
