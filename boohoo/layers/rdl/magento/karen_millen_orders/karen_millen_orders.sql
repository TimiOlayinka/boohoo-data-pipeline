...
------------------------------------------------------------------------------------------------------------------------
-- karen_millen_orders
-- Deduplicated Karen Millen orders from karen_millen_orders_history
------------------------------------------------------------------------------------------------------------------------
...
DROP TABLE IF EXISTS "rdl_magento".karen_millen_orders;

CREATE TABLE "rdl_magento".karen_millen_orders
...
WITH history AS (
    ...
    FROM "rdl_magento".karen_millen_orders_history
),
dedup AS (
