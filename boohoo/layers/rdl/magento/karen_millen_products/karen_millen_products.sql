...
------------------------------------------------------------------------------------------------------------------------
-- karen_millen_products
-- Deduplicated Karen Millen products from karen_millen_products_history
------------------------------------------------------------------------------------------------------------------------
...
DROP TABLE IF EXISTS "rdl_magento".karen_millen_products;

CREATE TABLE "rdl_magento".karen_millen_products
...
WITH history AS (
    ...
    FROM "rdl_magento".karen_millen_products_history
),
dedup AS (
...
SELECT
    ...
    'Karen Millen'                                  :: VARCHAR(50)      AS brand,
