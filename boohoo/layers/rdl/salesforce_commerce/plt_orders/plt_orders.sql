...
------------------------------------------------------------------------------------------------------------------------
-- plt_orders
-- Deduplicated PrettyLittleThing orders from plt_orders_history
------------------------------------------------------------------------------------------------------------------------
...
DROP TABLE IF EXISTS "rdl_salesforce_commerce".plt_orders;

CREATE TABLE "rdl_salesforce_commerce".plt_orders
...
WITH history AS (
    ...
    FROM "rdl_salesforce_commerce".plt_orders_history
),
dedup AS (
