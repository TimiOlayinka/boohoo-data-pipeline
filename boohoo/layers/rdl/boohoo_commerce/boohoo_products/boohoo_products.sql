...
------------------------------------------------------------------------------------------------------------------------
-- boohoo_products
-- Deduplicated Boohoo products from boohoo_products_history
------------------------------------------------------------------------------------------------------------------------
...
DROP TABLE IF EXISTS "rdl_boohoo_commerce".boohoo_products;

CREATE TABLE "rdl_boohoo_commerce".boohoo_products
...
WITH history AS (
    ...
    FROM "rdl_boohoo_commerce".boohoo_products_history
),
dedup AS (
