...
------------------------------------------------------------------------------------------------------------------------
-- boohoo_man_orders
-- Deduplicated Boohoo Man orders from boohoo_man_orders_history
------------------------------------------------------------------------------------------------------------------------
...
DROP TABLE IF EXISTS "rdl_boohoo_commerce".boohoo_man_orders;

CREATE TABLE "rdl_boohoo_commerce".boohoo_man_orders
...
WITH history AS (
    ...
    FROM "rdl_boohoo_commerce".boohoo_man_orders_history
),
dedup AS (
