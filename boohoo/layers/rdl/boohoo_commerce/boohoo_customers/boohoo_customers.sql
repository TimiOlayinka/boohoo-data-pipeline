...
------------------------------------------------------------------------------------------------------------------------
-- boohoo_customers
-- Deduplicated Boohoo customers from boohoo_customers_history
------------------------------------------------------------------------------------------------------------------------
...
DROP TABLE IF EXISTS "rdl_boohoo_commerce".boohoo_customers;

CREATE TABLE "rdl_boohoo_commerce".boohoo_customers
...
WITH history AS (
    ...
    FROM "rdl_boohoo_commerce".boohoo_customers_history
),
dedup AS (
