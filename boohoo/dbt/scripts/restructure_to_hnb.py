...
=====================
Restructures the boohoo dbt project to the Holland & Barrett folder-per-model standard.
...
def generate_model_yml(model_name: str, meta: dict) -> str:
    ...
    data = {
        ...
        'owners': {
            'workstream': 'boohoo-data-engineering',
            'analytics_owner': 'data-team@boohoo.com',
            'business_owner': f"{meta['domain']}-team@boohoo.com",
            'technical_owner': 'data-team@boohoo.com',
        },
        'service': {
