...
3. Re-run the specific model: `dbt run --select dim_campaigns`
4. If schema drift: update the RDL model SQL and re-run
5. Verify downstream models: `dbt run --select dim_campaigns+`

## Escalation
data-team@boohoo.com

## Related checks
- dbt test: `dbt test --select dim_campaigns`
