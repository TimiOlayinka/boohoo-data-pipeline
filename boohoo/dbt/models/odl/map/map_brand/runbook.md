...
3. Re-run the specific model: `dbt run --select map_brand`
4. If schema drift: update the RDL model SQL and re-run
5. Verify downstream models: `dbt run --select map_brand+`

## Escalation
data-team@boohoo.com

## Related checks
- dbt test: `dbt test --select map_brand`
