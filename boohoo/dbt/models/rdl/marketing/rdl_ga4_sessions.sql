...
WITH history AS (
    SELECT session_id, user_pseudo_id, session_date, session_timestamp,
           source, medium, channel_group, utm_campaign,
           device_category, country, landing_page,
           page_views, session_duration_seconds, is_bounced, is_engaged_session, is_new_user,
...
SELECT session_id, user_pseudo_id, session_date::DATE AS date_nk,
       ...
       transactions, revenue::NUMERIC(18,2) AS revenue,
