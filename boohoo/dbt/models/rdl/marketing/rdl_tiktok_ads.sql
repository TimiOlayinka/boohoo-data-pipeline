...
------------------------------------------------------------------------------------------------------------------------
WITH history AS (
    SELECT advertiser_id, ad_id, campaign_name, objective,
           stat_time_day, spend, impressions, clicks, reach, frequency,
           ctr, cpc, cpm, conversion_rate, conversion, cost_per_conversion, purchase,
...
SELECT advertiser_id, ad_id, campaign_name, objective,
       stat_time_day::DATE AS date_nk, spend, impressions, clicks, reach, frequency,
       ctr, cpc, cpm, conversion_rate, conversion, cost_per_conversion, purchase,
       video_play_actions, video_watched_2s, video_watched_6s,
       video_views_p25, video_views_p50, video_views_p75, video_views_p100,
