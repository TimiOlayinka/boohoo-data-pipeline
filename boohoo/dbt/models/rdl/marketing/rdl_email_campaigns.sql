...
WITH history AS (
    SELECT campaign_id, campaign_name, campaign_type, subject_line,
           send_date, send_timestamp, list_size,
           delivered, opened, unique_opens, clicked, unique_clicks,
           unsubscribed, bounced, spam_complaints,
           converted, revenue, open_rate, click_rate,
           click_to_open_rate, conversion_rate, revenue_per_email,
           brand,
...
SELECT campaign_id, campaign_name, campaign_type, subject_line,
       send_date::DATE AS date_nk, send_timestamp::TIMESTAMP AS send_timestamp,
       list_size, delivered, opened, unique_opens, clicked, unique_clicks,
       unsubscribed, bounced, spam_complaints,
       converted, revenue::NUMERIC(18,2) AS revenue,
