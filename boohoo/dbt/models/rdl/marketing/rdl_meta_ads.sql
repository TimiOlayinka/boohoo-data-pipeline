...
------------------------------------------------------------------------------------------------------------------------
WITH history AS (
    SELECT campaign_id, campaign_name, objective, account_id, publisher_platform,
           date_start, spend, impressions, clicks, reach, frequency,
           cpc, cpm, ctr, outbound_clicks, outbound_clicks_ctr,
...
SELECT campaign_id, campaign_name, objective, account_id, publisher_platform,
       date_start::DATE AS date_nk, spend, impressions, clicks, reach, frequency,
       cpc, cpm, ctr, outbound_clicks, outbound_clicks_ctr,
       video_p25_watched, video_p50_watched, video_p75_watched, video_p100_watched,
