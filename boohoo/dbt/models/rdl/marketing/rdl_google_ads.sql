...
------------------------------------------------------------------------------------------------------------------------
WITH history AS (
    SELECT customer_id, customer_name, campaign_id, campaign_name, campaign_status,
           channel_type, ad_group_id, ad_id, date_day, device, ad_network_type,
           cost_micros, spend, impressions, clicks, interactions,
...
SELECT customer_id, customer_name, campaign_id, campaign_name, campaign_status,
       channel_type, ad_group_id, ad_id, date_day::DATE AS date_nk, device, ad_network_type,
       cost_micros, spend, impressions, clicks, interactions,
       conversions, conversions_value, all_conversions, all_conversions_value,
       video_quartile_p25_rate, video_quartile_p50_rate,
       video_quartile_p75_rate, video_quartile_p100_rate,
